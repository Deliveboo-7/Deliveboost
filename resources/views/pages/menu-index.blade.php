...
{{-- -------------------------- COVER IMAGE AND TITLE ------------------------- --}}
    ...
    <div class="container-fluid containerPageMenu px-0 " id="cart-anna">
...
<div class="container">
    ...
    <div class="row mt-4">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        ...
                        <!-- ------ right ------ -->
                        <div class="col-6 opening tab-border-l p-2 ">
                            <div class="col-12">
        ...
        <div class="col-12 col-lg-6 offset-lg-6 order-3 py-3" >
            ...
            {{-- --------------------------BUTTON CHECKOUT------------------------- --}}
            <button type="button" class=" order-3 order-lg-3 btn btn-checkout btn-lg btn-block d-flex justify-content-around">
